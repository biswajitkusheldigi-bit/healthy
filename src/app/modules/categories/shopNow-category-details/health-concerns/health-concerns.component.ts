...
@Component({
    ...
    templateUrl: './health-concerns.component.html',
    styleUrls: ['./health-concerns.component.scss'],
    imports: [
        CommonModule,
        FiltersComponent,
        ProductComponent,
...
export class HealthConcernsComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.activatedRoute.paramMap.subscribe(paramMap => {
            if (paramMap.get('health-concern')) {
                this.healthConcern = paramMap.get('health-concern') || '';
    ...
    getFilters(healthConcern: string) {
        ...
        this.shopNowService.getHealthConcernFilters(healthConcern).subscribe(
            (response: any) => {
    ...
    getHealthConcernDetails(healthConcern: string) {
        ...
        this.shopNowService.getHealthConcernDetails(payload).subscribe(response => {
            this.loader = false;
            if (response.data) {
